...
`z_exec:run/4` with the originating site context; the runner executes media profiles
using the native sandbox when supported and returns the result to an authenticated
HTTPS callback. Plain
